  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto">
      ...
      >
        ...
        <button formAction={signIn} className="bg-blue-600 hover:bg-blue-700 text-white rounded px-4 py-2 mb-2">
          ログイン
        </button>
        <Link href="/register" className="border border-slate-300 rounded px-4 py-2 mb-2 text-center">
          新規登録
        </Link>
